...
- **🤖 今日 AI 智慧精選 Top 5**：
  ...
  - **命中率 Wilson 下界排序**：解析每條趨勢的過盤紀錄（如 32 of last 45），過濾樣本過小（< 8 場）的雜訊趨勢，並以 Wilson 90% 信賴下界排序——小樣本的高命中率會被自動壓低，大樣本的穩定命中自然勝出。卡片同時顯示原始過盤紀錄（32/45, 71%）與保守下界。網頁最上方渲染「今日 AI 推薦 Top 5」精選卡片。
